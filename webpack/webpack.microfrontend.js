...
module.exports = (config, options, targetOptions) => {
  return {
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          '@angular/core': { singleton: true, strictVersion: true, requiredVersion: '13.2.4' },
          '@angular/common': { singleton: true, strictVersion: true, requiredVersion: '13.2.4' },
          '@angular/common/http': { singleton: true, strictVersion: true, requiredVersion: '13.2.4' },
          '@angular/router': { singleton: true, strictVersion: true, requiredVersion: '13.2.4' },
          '@angular/forms': { singleton: true, strictVersion: true, requiredVersion: '13.2.4' },
          '@angular/platform-browser': { singleton: true, strictVersion: true, requiredVersion: '13.2.4' },
          ...
          '@fortawesome/fontawesome-svg-core': { singleton: true, strictVersion: true, requiredVersion: '1.3.0' },
          '@fortawesome/free-solid-svg-icons': { singleton: true },
          '@ng-bootstrap/ng-bootstrap': { singleton: true, strictVersion: true, requiredVersion: '12.0.0' },
          ...
          rxjs: { singleton: true, strictVersion: true, requiredVersion: '7.5.4' },
          'rxjs/operators': { singleton: true, strictVersion: true, requiredVersion: '7.5.4' },
    ...
    output: {
      publicPath: 'auto',
      uniqueName: 'autorentalmanagement',
