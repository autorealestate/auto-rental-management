...
@RestController
@RequestMapping("/api/auto-rental-management-kafka")
public class AutoRentalManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AutoRentalManagementKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AutoRentalManagementKafkaResource(KafkaProperties kafkaProperties) {
