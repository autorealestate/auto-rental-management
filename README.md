...
To build the final jar and optimize the autoRentalManagement application for production, run:
...
Then navigate to [http://localhost:8383](http://localhost:8383) in your browser.
